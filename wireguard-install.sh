...
function installQuestions() {
	...
	echo "The git repository is available at: https://github.com/gooroo363/wireguard-install"
	echo ""
	echo "We need to ask a few questions before starting the setup."
